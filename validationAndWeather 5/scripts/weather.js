...
let selStatesChange = document.querySelector("#selStates");
...
selStatesChange.addEventListener("change",function(){
   let val = selStatesChange.value;
   console.log("val",val);
   let newList = getStationsByState(val);
   displayStationTable(newList,tableRoot);
});
